...
- AI Sales Copilot：商机评分、预测金额、风险摘要、跟进话术、订单草稿建议、推荐历史留痕
...
- `backend/` 已实现 FastAPI API、SQLite 数据库、资源创建/编辑/删除、订单创建、订单生命周期编辑、订单明细重算、库存差额调整、订单库存审计、库存补货建议、库存流水、销售 BI 报表、资源列表分页/搜索/筛选、Copilot 摘要、推荐历史和测试。
